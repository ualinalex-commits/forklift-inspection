...
// Extracted from PL054-OP-V3 template via pdfjs-dist (extractPage3Coords.mjs):
//   "Operator Name"  x=27.25  y=374.63  w=71.71  rightEdge=98.96
//     → name cell space: x=98.96 → 297.13 (empty cell span)
//   "Sign"           x=297.13 y=374.63  w=19.12  rightEdge=316.25
//     → sign cell space: x=316.25 → 460.45 (empty cell span)
//   "Date"           x=460.45 y=374.63  w=21.76  rightEdge=482.21
//   Each value stamped at rightEdge + 5pt.
...
const P3 = {
  ...
  OP_NAME_X:   104.0,  // "Operator Name" rightEdge=98.96 + 5pt → 103.96 ≈ 104.0
  OP_NAME_Y:   374.6,  // "Operator Name" label baseline
  OP_SIGN_X:   321.3,  // "Sign" rightEdge=316.25 + 5pt → 321.25 ≈ 321.3
  OP_SIGN_Y:   355,    // image bottom — occupies y=355–375, centred in row below "Sign" text
  OP_SIGN_MAX_W:  60,  // signature scaled to ~60×20pt so it fits neatly in the Sign cell
  OP_SIGN_MAX_H:  20,
  OP_DATE_X:   487.2,  // "Date" rightEdge=482.21 + 5pt → 487.21 ≈ 487.2
