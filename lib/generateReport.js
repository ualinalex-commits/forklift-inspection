...
const P3 = {
  ...
  OP_NAME_X:   120,    // "Operator Name" label ends at x=99.0; value at x=120 (21pt clearance)
  OP_NAME_Y:   374.6,  // "Operator Name" label baseline
  OP_SIGN_X:   322,    // "Sign" label ends at x=316.2; image starts at x=322
  OP_SIGN_Y:   355,    // image bottom — occupies y=355–375, centred in row below "Sign" text
  OP_SIGN_MAX_W: 128,  // available width to "Date" label at x=460.5 minus gap: 460.5-322-10=128.5
  OP_SIGN_MAX_H:  18,  // fits within row gap (operator y=374.6, supervisor y=340.9 → 33.7pt)
  OP_DATE_X:   497,    // "Date" label ends at x=482.3; value at x=497 (14.7pt clearance)
